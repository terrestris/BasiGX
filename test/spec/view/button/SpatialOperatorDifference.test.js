...
describe('BasiGX.view.button.SpatialOperatorDifference', function() {
    describe('Basics', function() {
        it('is defined', function() {
            expect(BasiGX.view.button.SpatialOperatorDifference).
                to.not.be(undefined);
        });
        it('can be instantiated', function() {
            var btn = Ext.create(
                'BasiGX.view.button.SpatialOperatorDifference');
            expect(btn).to.be.a(BasiGX.view.button.SpatialOperatorDifference);
            // teardown
            btn.destroy();
        });
    });
    ...
    describe('Handler', function() {
        it('generates a valid difference of two geometries', function() {
            var btn = Ext.create(
                'BasiGX.view.button.SpatialOperatorDifference', {
                    targetVectorLayer: new ol.layer.Vector({
                        source: new ol.source.Vector()
